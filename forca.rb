...
def escolhe_palavra_secretapalava
	avisa_escolhendo_palavra
	texto = File.read("dicionario.txt")
	todas_as_palavras = texto.split("\n")
	numero_escolhido = rand(todas_as_palavras.size)
	palavra_secreta = todas_as_palavras[numero_escolhido].downcase
	return avisa_palavra_escolhida(palavra_secreta)
end


def escolhe_palavra_secretapalava_sem_usar_muita_memoria
	avisa_escolhendo_palavra
...
def joga(nome)
	palavra_secreta = escolhe_palavra_secretapalava
